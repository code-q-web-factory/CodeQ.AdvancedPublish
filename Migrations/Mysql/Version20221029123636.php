 ...
 */
final class Version20221029123636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE codeq_advancedpublish_domain_model_publication_events_join (advancedpublish_publication VARCHAR(40) NOT NULL, eventlog_event INT UNSIGNED NOT NULL, INDEX IDX_143C3C6564D1D52A (advancedpublish_publication), UNIQUE INDEX UNIQ_143C3C6573FC4D4A (eventlog_event), PRIMARY KEY(advancedpublish_publication, eventlog_event)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
